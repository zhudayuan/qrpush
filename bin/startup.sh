...
# SERVER_PORT=`sed '/server.port/!d;s/.*=//' config/qr.conf | tr -d '\r'`
# 获取应用的端口号
...
CONFIG_FILES=" -Dlogging.path=$LOGS_DIR -Dlogging.config=$CONF_DIR/log4j2.xml -Dspring.config.location=$CONF_DIR/qr.conf "
